...
* As a poll user, when I receive a poll from a friend as a submission link, I want to be able to open the poll to see the questions and make a decision, 
* As a poll user, I want to be able to rank the responses in the poll in the order I choose to specify my preference(s), 
